...
def make_palette(groups):
    ...
    # completed run ends with results written and no figures.
    taken = {i for g, i in fixed_cols.items() if g in groups}
    unused = [i for i in range(len(GROUP_COLORS)) if i not in taken]
    palette = {}
